...
public interface IngressesApi extends KubeApi<Ingress>, NamespaceAwareKubeApi<Ingress,DefaultIngressCreationBuilder,IngressUpdater,NamespacedIngressesApi> {
